...
module.exports.getThingInfoLog = exports.getThingInfoLog = function(tId, bId){
    var getThingLogPromise = new Promise(
        ...
        function(resolve, reject){
            ...
            request({
                url: FABRIC_COMPOSER_REST_URL + "/api/InfoEvent" + "?filter=" + filterQuery,
                method: "GET"
            }, function (error, response, body){
                ...
                if (!error && response.statusCode == 200) {
                    ...
                    console.log("getThing Info Events error : ", response);
                    reject(error);
                }                         
...
module.exports.getThingDamageLog = exports.getThingDamageLog = function(tId, bId){
    var getThingLogPromise = new Promise(
        ...
        function(resolve, reject){
            ...
            request({
                url: FABRIC_COMPOSER_REST_URL + "/api/DamageEvent" + "?filter=" + filterQuery,
                method: "GET"
            }, function (error, response, body){
                ...
                if (!error && response.statusCode == 200) {
                    ...
                    console.log("getThing Damage Events error : ", response);
                    reject(error);
                }                         
...
module.exports.getThingRepairLog = exports.getThingRepairLog = function(tId, bId){
    var getThingLogPromise = new Promise(
        ...
        function(resolve, reject){
            ...
            request({
                url: FABRIC_COMPOSER_REST_URL + "/api/RepairEvent" + "?filter=" + filterQuery,
                method: "GET"
            }, function (error, response, body){
                ...
                if (!error && response.statusCode == 200) {
                    ...
                    console.log("getThing Repair Events error : ", response);
                    reject(error);
                }                         
...
module.exports.createDamageEvent = exports.createDamageEvent = function(newEvent, res){
    
    //console.log(newEvent);

    request({
        url: FABRIC_COMPOSER_REST_URL + "/api/DamageEvent",
        method: "POST",
        json: true,
        body: newEvent
    }, function (error, response, body){
        ...
        if (!error && response.statusCode == 200) {
            ...
            console.log("createDamageEvent error : ", body);
        }                
    });
}

module.exports.createRepairEvent = exports.createRepairEvent = function(newEvent, res){
    
    //console.log(newEvent);

    request({
        url: FABRIC_COMPOSER_REST_URL + "/api/RepairEvent",
        method: "POST",
        json: true,
        body: newEvent
    }, function (error, response, body){
